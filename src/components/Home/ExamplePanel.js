...
export default function ExamplePanel() {
    ...
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell>	            <p style={{fontSize: 20}}>Two files were inserted, one for cytokine measurments and another for outcome measurments. The files can be seen in the method <a href="https://github.com/hadas-schlessinger/CytoMod/tree/master/app/static/fc9ac628-bb13-11ea-a20f-0242ac120002/data_files">git repository</a></p>
</Table.Cell>
      </Table.Row>
      <Table.Row>
